...
// Deliverable 3 - create the third tile layer
// chose navigation to see if earthquakes are along major roadways
...
let overlays = {
  ...
  "Major Earthquakes This Week": majorEarthquakes
};
...
// legend for all earthquakes to the map.
legendMajor.addTo(map);

  // Here we create a legend control object for all earthquakes.
